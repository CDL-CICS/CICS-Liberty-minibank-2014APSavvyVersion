...
public class TransferCommarea {
	...
	public String getTranResult() {
		...
		try {
			data = new String(TRANRESULT, System.getProperty("com.ibm.cics.jvmserver.local.ccsid"));
	...
	public String getTranMessage() {
		...
		String data = "";
		try {
			data = new String(MESSAGE, System.getProperty("com.ibm.cics.jvmserver.local.ccsid"));
		} catch (UnsupportedEncodingException e) {
			// TODO Auto-generated catch block
	...
	public String getSourceAcctBalance() {
		...
		String decimal = "";
		try {
			//data = new String(SOURCE_BAL, System.getProperty("com.ibm.cics.jvmserver.local.ccsid"));
	...
	public String getTargetAcctBalance() {
		...
		String decimal = "";
		try {
			//data = new String(TARGET_BAL, System.getProperty("com.ibm.cics.jvmserver.local.ccsid"));
	...
	protected void initCommArea() {
		...
		try {
			...
			byte[] data = tempStr.getBytes(System.getProperty("com.ibm.cics.jvmserver.local.ccsid"));
